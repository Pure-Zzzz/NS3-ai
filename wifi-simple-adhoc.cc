...
main(int argc, char* argv[])
{
    ...
    Vector s(5, 0, 0);
    c.Get(0)->GetObject<ConstantVelocityMobilityModel>()->SetVelocity(s);
    mobility.Install(c);
    Ptr<MobilityModel> mobilityModel1 = c.Get(0)->GetObject<MobilityModel>();
    Ptr<MobilityModel> mobilityModel2 = c.Get(1)->GetObject<MobilityModel>();
    double distance = mobilityModel1->GetDistanceFrom(mobilityModel2);
